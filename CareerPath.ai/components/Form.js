...
export default function Form() {
  ...
  return (
    <form onSubmit={submit} className="form-container">
      ...
      <label>Skills (check all):
        <div>
          <label><input type="checkbox" value="Logic" onChange={handleChange} /> Logic</label>
          ...
          <label><input type="checkbox" value="Communication" onChange={handleChange} /> Communication</label>
          <label><input type="checkbox" value="Problem Solving" onChange={handleChange} /> Problem Solving</label>
      ...
      <label>Time Commitment: 
        <select name="timeCommit" onChange={handleChange} required>
          <option value="">Select</option>
      ...
      <label>Work Style: 
        <select name="workStyle" onChange={handleChange} required>
          <option value="">Select</option>
          <option>Solo</option>
          <option>Team</option>
